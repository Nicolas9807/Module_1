...
public class ShoppingCart{
     ...
     * For REGULAR discount is 0%;
     * For SECOND discount is 50% if quantity > 1
     * For DISCOUNT discount is 10% + 10% for each full 10 items, but not more than 50% total
     * For SALE discount is 90%
